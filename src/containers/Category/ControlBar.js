...
class ControlBar extends React.Component {
  constructor(props) {
    ...
    this.options = [
      {
        title: 'Sort by Date descending', order: "desc", orderby: "date"
      },
      {
        title: 'Sort by Date ascending', order: "asc", orderby: "date"
      },
      {
        title: 'Sort by Name descending', order: "desc", orderby: "title"
      },
      {
        title: 'Sort by Name ascending', order: "asc", orderby: "title"
      },
      {
      ...
      <View
        ...
        <View style={styles.iconAndTextWrap}>
          <TouchableOpacity
            ...
            />
            <Text style={[styles.text, { color: text }]}>{name.replace(/&amp;/g, '&')}</Text>
          </TouchableOpacity>
          <TouchableOpacity
